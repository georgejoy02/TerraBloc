  ...
  return (
      ...
      <Toolbar>
        ...
        <Stack direction='row' spacing={2} >
          ...
          <Button component={Link} to="/about" color='primary' variant="contained">LogIn</Button>
          <Button component={Link} to="/about" color='primary' variant="contained">SignUp</Button>
        </Stack>
      </Toolbar>
    </AppBar>
  )
