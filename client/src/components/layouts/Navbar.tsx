      ...
      <AppBar position="fixed" style={{ backgroundColor: '#fff', zIndex:1 }} >
        <Toolbar>
          ...
          <Stack direction='row' spacing={2} >
            <Button component={Link} to="/" sx={{ color: "#122f47" }}>Home</Button>
            <Button component={Link} to="/landgallery" sx={{ color: "#122f47" }}>LandGallery</Button>
            <Button component={Link} to="/news" sx={{ color: "#122f47" }}>News</Button>
            <Button component={Link} to="/contact" sx={{ color: "#122f47" }}>Contact</Button>
            <Divider orientation="vertical" flexItem style={{color:"#104775"}} />
