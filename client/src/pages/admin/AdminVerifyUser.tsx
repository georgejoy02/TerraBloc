        ...
        const fetchAddressDetails = async () => {
            ...
            for (const address of addresses) {
                try {
                    ...
                    detailsArray.push(createData(i, res.data.id, res.data.name, res.data.aadharNumber, res.data.panNumber, res.data.document, res.data.userVerified));
                    i++;
                } catch (error) {
                ...
                <TableBody>
                    {rows.map((row: any) => (
                        ...
                        >
                            ...
                            <TableCell>{row.verify ?
                                <Button disabled>verified</Button> :
                                <Button variant='contained' onClick={() => handleVerify(row.address)}>verify</Button>}
                            </TableCell>
                        </TableRow>
                    ))}
                </TableBody>
